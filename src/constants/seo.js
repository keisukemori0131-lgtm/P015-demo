...
export const PAGE_SEO = {
  ...
  '/support': {
    title: `児童発達支援｜${SITE.name}`,
    description:
      '発達に特性のある未就学のお子さまを対象とした児童発達支援。英語に親しみ、身体を育て、社会性と成功体験を積み重ねながら、小学校入学に向けた力を育てます。見学・体験、よくあるご質問もご覧いただけます。',
  },
  '/after-school': {
    title: `放課後等デイサービス｜${SITE.name}`,
    description:
      '発達に特性のある小学生から高校生までのお子さまを対象にした放課後等デイサービス。英語・運動・知育を通して、一人ひとりの「好き」や「得意」を伸ばし、自信と社会性を育みます。',
  },
  '/special': {
    title: `独自の取り組み（ペラペラスペシャル）｜${SITE.name}`,
    description:
      'メディカルレッスン、PTサポートなど、専門家と連携したペラペラスタジオ独自の取り組み「ペラペラスペシャル」をご紹介します。',
  },
  '/counseling': {
    title: `こころの相談室｜${SITE.name}`,
    description:
      'ママ、パパ、ご家族のための心のサポートルーム「ペラペラ こころの相談室」。家族支援カウンセラー・保育士の資格を持つ心理学カウンセラーが、対面・オンラインで子どもと家族の心をサポートします。',
  },
  '/cases': {
  ...
  '/contact': {
    ...
    description:
      '見学・体験のお申し込み、お子さまの発達についてのご相談は、お問い合わせフォームからお気軽にどうぞ。ペラペラスタジオ（円山ベース・宮の森ベース）。',
  },
}
